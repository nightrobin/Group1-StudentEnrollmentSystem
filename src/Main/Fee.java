...
public class Fee extends JFrame {
    ...
    public Fee()
    {
        ...
        l4 = new JLabel("Name of the Mother:");
        ...
        String language[]
                = { "Below 79", "80-85","85-89", "90-94", "95-100", };
        ...
        l14 = new JLabel("Annual Gross Family Income:");
        ...
        Image image = null;
        try {
            URL url = new URL("https://plm.edu.ph/images/stories/history-facade.jpg");
        ...
        l16 = new JLabel(
                "Select Year Level and Amount:");
        l16.setBounds(600 , 250, 250, 20);

        li1.addElement("1st Year with a amount of (10,000)");
        li1.addElement("2nd Year with a amount of (20,000)");
        li1.addElement("3rd Year with a amount of (30,000)");
        li1.addElement("4th Year with a amount of (40,000)");
        li1.addElement("Scholarship with FREE Tuition");

        final JList<String> list1
                = new JList<>(li1);

        list1.setBounds(600, 300, 250, 125);
        ...
        b.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (list1.getSelectedIndex() != -1) {
                    data = "You have been Enrolled to:"
                            + list1.getSelectedValue();
                    label.setText(data);
                }
                if (list2.getSelectedIndex() != -1) {
                    data += " you Payment Process is "
                            + "for: ";
        ...
        Receipt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (rb3.isSelected()) {
                    area2.setText(area2.getText()
                            + "\nStudent Type: Scholar"
                    );
                }
                if (rb4.isSelected()) {
                    area2.setText(area2.getText()
                            + "\nStudent Type: Not Scholar "
                    );
                }
                area2.setText(area2.getText()
                        + "\nHad chosen: "
