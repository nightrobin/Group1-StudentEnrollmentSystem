...
public class Main {
    ...
    public static void main(String[] args){
        ...
        f.add(l); f.add(l1); f.add(l2); f.add(l3); f.add(l4); f.add(l5); f.add(l6); f.add(l7); f.add(l8);
        ...
        t5=new JTextField("Enter address here...");
        t5.setBounds(180,250, 200,30);
        t6=new JTextField("Enter father's name here...");
        t6.setBounds(180,290, 200,30);
        t7=new JTextField("Enter mother's name here...");
        t7.setBounds(180,330, 200,30);
        t8=new JTextField("Enter GWA here...");
